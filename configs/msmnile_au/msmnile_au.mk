...
PRODUCT_COPY_FILES += \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/msmnile_au/card-defs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/card-defs.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/msmnile_au/mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.xml \
