...
include vendor/qcom/opensource/audio-hal/primary-hal/configs/chora/audio-modules.mk
...
PRODUCT_PACKAGES += fai__2.0.0_0.1__3.0.0_0.0__3.1.2_0.0__3.2.0_0.1__eai_3.18_adsp.pmd
PRODUCT_PACKAGES += fai__4.14.0_0.0__3.0.0_0.0__3.1.2_0.0__3.2.0_0.1__eai_3.18_adsp.pmd
...
PRODUCT_COPY_FILES += \
        ...
        $(CONFIG_PAL_SRC_DIR)/mixer_paths_ravelin_qrd.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_ravelin_qrd.xml \
        $(CONFIG_PAL_SRC_DIR)/mixer_paths_ravelin_idp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_ravelin_idp.xml \
...
QCV_FAMILY_SKUS := chora
DEVICE_SKU := chora
UV_WRAPPER2 := false

CONFIG_PAL_SRC_DIR := vendor/qcom/opensource/pal/configs/qcom/$(BA_NAME)/chora
CONFIG_HAL_SRC_DIR := vendor/qcom/opensource/audio-hal/primary-hal/configs/chora
CONFIG_SKU_OUT_DIR := $(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)
...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_HAL_SRC_DIR)/microphone_characteristics.xml:$(TARGET_COPY_OUT_VENDOR)/etc/microphone_characteristics.xml \
    $(CONFIG_PAL_SRC_DIR)/card-defs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/card-defs.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_chora_mtp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_chora_mtp.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_chora_mtp_qmp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_chora_mtp_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_chora_atp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_chora_atp.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_chora_cdp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_chora_cdp.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_chora_qrd.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_chora_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_chora_atp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_chora_atp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_chora_cdp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_chora_cdp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_chora_qrd.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_chora_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_chora_mtp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_chora_mtp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_chora_mtp_qmp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_chora_mtp_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_chora_mtp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_chora_mtp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_chora_mtp_qmp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_chora_mtp_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_chora_atp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_chora_atp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_chora_qrd.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_chora_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_chora_cdp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_chora_cdp.xml \
    $(CONFIG_PAL_SRC_DIR)/usecaseKvManager.xml:$(TARGET_COPY_OUT_VENDOR)/etc/usecaseKvManager.xml \
...
PRODUCT_COPY_FILES += \
    $(CONFIG_HAL_SRC_DIR)/audio_module_config_primary.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_module_config_primary.xml
PRODUCT_COPY_FILES += \
    $(CONFIG_HAL_SRC_DIR)/audio_module_config_primary_bourtzi.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_module_config_primary_bourtzi.xml
endif
...
include vendor/qcom/opensource/audio-hal/primary-hal/configs/chora/audio-properties.mk
