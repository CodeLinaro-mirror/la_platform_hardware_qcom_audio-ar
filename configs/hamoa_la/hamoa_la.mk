...
include vendor/qcom/opensource/audio-hal/primary-hal/configs/hamoa_la/audio-modules.mk
...
QCV_FAMILY_SKUS := hamoa_la
DEVICE_SKU := hamoa_la
UV_WRAPPER2 := false

CONFIG_PAL_SRC_DIR := vendor/qcom/opensource/pal/configs/qcom/$(BA_NAME)/hamoa_la
CONFIG_HAL_SRC_DIR := vendor/qcom/opensource/audio-hal/primary-hal/configs/hamoa_la
...
PRODUCT_COPY_FILES += \
$(find-copy-subdir-files DEVICE_SKU, $(QCV_FAMILY_SKUS), \
...
include vendor/qcom/opensource/audio-hal/primary-hal/configs/hamoa_la/audio-properties.mk
