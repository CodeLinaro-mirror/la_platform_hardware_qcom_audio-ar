...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_art_qrd.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_art_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_art_qrd_qmp.xml:$(CONFIG_SKU_OUT_DIR)/mixer_paths_art_qrd_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_art_cdp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_art_cdp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_art_mtp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_art_mtp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_art_mtp_qmp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_art_mtp_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_art_qrd.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_art_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_art_qrd_qmp.xml:$(CONFIG_SKU_OUT_DIR)/resourcemanager_art_qrd_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_art_cdp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_art_cdp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_art_mtp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_art_mtp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_art_mtp_qmp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_art_mtp_qmp.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_art_qrd.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_art_qrd.xml \
    $(CONFIG_PAL_SRC_DIR)/mcs_defs_art_qrd_qmp.xml:$(CONFIG_SKU_OUT_DIR)/mcs_defs_art_qrd_qmp.xml \
