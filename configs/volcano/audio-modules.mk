...
AUDIO_MODULES += audio.primary.volcano
...
AUDIO_MODULES += ftm_test_config_volcano-qrd-wsa883x_sku1-snd-card
AUDIO_MODULES += audioadsprpcd
AUDIO_MODULES += android.hardware.audio.service_64
AUDIO_MODULES += MTP_6i_hac_wsa883x_acdb_cal.acdb
AUDIO_MODULES += MTP_6i_hac_wsa883x_workspaceFileXml.qwsp
...
AUDIO_MODULES += MTP_6i_mtp_wsa883x_acdb_cal.acdb
AUDIO_MODULES += MTP_6i_mtp_wsa883x_workspaceFileXml.qwsp
AUDIO_MODULES += MTP_6i_msl_wsa883x_acdb_cal.acdb
AUDIO_MODULES += MTP_6i_msl_wsa883x_workspaceFileXml.qwsp
AUDIO_MODULES += CDP_6i_wcd939x_acdb_cal.acdb
AUDIO_MODULES += CDP_6i_wcd939x_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_6i_acdb_cal.acdb
AUDIO_MODULES += QRD_6i_workspaceFileXml.qwsp
...
AUDIO_MODULES += MTP_sku1_acdb_cal.acdb
AUDIO_MODULES += MTP_sku1_workspaceFileXml.qwsp
AUDIO_MODULES += MTP_sku1_wcd939x_acdb_cal.acdb
AUDIO_MODULES += MTP_sku1_wcd939x_workspaceFileXml.qwsp
AUDIO_MODULES += CDP_sku1_wcd939x_acdb_cal.acdb
AUDIO_MODULES += CDP_sku1_wcd939x_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_sku1_acdb_cal.acdb
AUDIO_MODULES += QRD_sku1_workspaceFileXml.qwsp
AUDIO_MODULES += IDP_UPD_acdb_cal.acdb
AUDIO_MODULES += IDP_UPD_workspaceFileXml.qwsp
AUDIO_MODULES += MTP_wcn6450_acdb_cal.acdb
AUDIO_MODULES += MTP_wcn6450_workspaceFileXml.qwsp
