...
AUDIO_MODULES += ftm_test_config_shikra_64-mtp-qmp-snd-card
AUDIO_MODULES += ftm_test_config_shikra_64-qrd-snd-card
AUDIO_MODULES += ftm_test_config_shikra_64-qrd-qmp-snd-card

AUDIO_MODULES += audioadsprpcd
AUDIO_MODULES += MTP_acdb_cal.acdb
AUDIO_MODULES += MTP_workspaceFileXml.qwsp
AUDIO_MODULES += MTP_shikra_64_qmp_acdb_cal.acdb
AUDIO_MODULES += MTP_shikra_64_qmp_workspaceFileXml.qwsp
...
AUDIO_MODULES += QRD_shikra_64_qmp_acdb_cal.acdb
AUDIO_MODULES += QRD_shikra_64_qmp_workspaceFileXml.qwsp
