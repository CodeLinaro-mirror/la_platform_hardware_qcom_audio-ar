...
AUDIO_MODULES += ftm_test_config_diwali-idp-sku1-snd-card
AUDIO_MODULES += ftm_test_config_diwali-idp-snd-card
AUDIO_MODULES += ftm_test_config_diwali-qrd-sku1-snd-card
AUDIO_MODULES += ftm_test_config_diwali-qrd-snd-card
AUDIO_MODULES += ftm_test_config_waipio-qrd-snd-card
...
AUDIO_MODULES += IDP_UPD_diwali_acdb_cal.acdb
AUDIO_MODULES += IDP_UPD_diwali_workspaceFileXml.qwsp
AUDIO_MODULES += IDP_diwali_acdb_cal.acdb
AUDIO_MODULES += IDP_diwali_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_diwali_acdb_cal.acdb
AUDIO_MODULES += QRD_diwali_workspaceFileXml.qwsp
AUDIO_MODULES += IDP_diwali_sku1_acdb_cal.acdb
AUDIO_MODULES += IDP_diwali_sku1_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_diwali_sku1_acdb_cal.acdb
AUDIO_MODULES += QRD_diwali_sku1_workspaceFileXml.qwsp
AUDIO_MODULES += MTP_ukee_acdb_cal.acdb
AUDIO_MODULES += MTP_ukee_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_ukee_acdb_cal.acdb
AUDIO_MODULES += QRD_ukee_workspaceFileXml.qwsp
AUDIO_MODULES += CDP_ukee_acdb_cal.acdb
AUDIO_MODULES += CDP_ukee_workspaceFileXml.qwsp
AUDIO_MODULES += QRD_diwali_parrot_acdb_cal.acdb
AUDIO_MODULES += QRD_diwali_parrot_workspaceFileXml.qwsp
