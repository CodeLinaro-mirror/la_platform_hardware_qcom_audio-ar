...
#ifndef _QTI_GEF_AR_API_H_
#define _QTI_GEF_AR_API_H_
 ...
 */
gef_handle_t* gef_register_session(aidl::android::media::audio::common::AudioUuid effectId);
...
void gef_interface_init(void);
void gef_interface_deinit(void);
#ifdef __cplusplus
}
#endif
#endif /* _QTI_GEF_AR_API_H_ */
